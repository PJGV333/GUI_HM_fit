...
def run_spectroscopy(config: Mapping[str, Any] | Any, progress_cb: ProgressCallback = None) -> dict[str, Any]:
    ...
    return process_spectroscopy_data(
        ...
        solver_param_transform=cfg.get("solver_param_transform"),
        solver_model_settings=str(cfg.get("solver_model_settings") or cfg.get("model_settings") or "Free"),
        param_names=list(cfg.get("param_names") or []),
